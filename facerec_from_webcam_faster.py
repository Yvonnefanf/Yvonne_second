...
# references: http://opencv-python-tutroals.readthedocs.io/en/latest/py_tutorials/py_gui/py_video_display/py_video_display.html#display-video
...
# obama_image = face_recognition.load_image_file("./known_people/weige.jpg")
